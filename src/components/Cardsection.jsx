...
const Cardsection = () => {
    const list = card2.map((card2) => (
        <Col lg={4} md={6} className='mt-3 pt-3 pt-lg-0 '>
            <Card className='card2 position-relative overflow-hidden'>
                <div className=' text-center pt-4'>{card2.svg}</div>
                <h2 className='ff-Montserrat fw-semibold fs-md lh-109 text-white text-center pt-3'>{card2.heading}</h2>
                <p className='ff-Montserrat fw-normal fs-xs lh-160 text-white text-center pt-1 max-w-350 mx-auto'>{card2.para}</p>
